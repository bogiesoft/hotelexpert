...
<table width="986" align="center" border="0" cellpadding="0" cellspacing="0" style="border:1px #aaaaaa solid; margin-top:30px; border-top:none; border-radius:10px; ">
  ...
  <table width="966"  border="0" align="center" style="border:1px #9d9d9d solid; margin-top:10px; background-color:#efefef; border-radius:8px;">
    ...
    <ul class="tabs1">
             ...
             <li><a href="<?php echo WEB_URL;?>home/discount_rules"  id="tabs_active">Discount Rules</a></li>
 ...
 <div  class="right_header"><strong><a href="<?php echo WEB_URL;?>index/dashboard">Go back</a></strong></div>
		...
		<div class="tb" style="width:738px">
            ...
            <div class="tb_col_01" style="background-color:#ccc; font-weight:bold; color:#000;width:140px;">Rule Name</div>
			<div class="tb_col_01" style="background-color:#ccc; font-weight:bold; color:#000;width:140px;">Rule type</div>
            <div class="tb_col_01" style="background-color:#ccc; font-weight:bold; color:#000;width:140px;">Discount Rate</div>
        ...
        <div class="tb_sample_cover211" style="width:882px">
            ...
            <div class="tr_col_01  bl_2" style="width:140px;"><?php echo $result[$i]->rule_name; ?></div>
			<div class="tr_col_01  bl_2" style="width:140px;"><?php $discount=$this->common_model->get_discount_parameters($result[$i]->discount_parameter); echo $discount[0]->parameter; ?></div>
           <div class="tr_col_01  bl_2" style="width:140px;"><?php echo $result[$i]->discount_rate." ".$result[$i]->basis; ?></div>
		   <div class="tr_col_01 bl_1" style="width:140px;"><?php if($result[$i]->status==1) { echo "Active";}else {echo "InActive";} ?></div>
            ...
            <a href="<?php echo WEB_URL;?>home/edit_discount_rule/<?php echo $result[$i]->id; ?>">Edit</a>/
             <a href="<?php echo WEB_URL;?>home/update_discount_rules/<?php echo $result[$i]->id; ?>/1">Active</a> /
              <a href="<?php echo WEB_URL;?>home/update_discount_rules/<?php echo $result[$i]->id; ?>/0">InActive</a>/
                <span style="font-size:12px;"><?php echo anchor(WEB_URL.'home/update_discount_rules/'.$result[$i]->id.'/2', '<span style="color:#2485BE;">Delete</span>', array('onClick' => "return confirm('Are you sure you want to delete?')")); ?> </span>
