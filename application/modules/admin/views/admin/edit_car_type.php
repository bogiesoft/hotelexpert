...
<table width="986" align="center" border="0" cellpadding="0" cellspacing="0" style="border:1px #aaaaaa solid; margin-top:30px; border-top:none; border-radius:10px; ">
 ...
 <div  class="right_header"><strong><a href="<?php echo WEB_URL;?>index/global_car_type">Go back</a></strong></div>

      </div>
        
        <div class="tablebox" style="width:910px; margin:0px">
        
         <form name="f2" action="<?php echo WEB_URL;?>index/update_car_type_details/<?php echo $this->uri->segment(3)?>" method="post">
		<table width="400">
			<tr>
				<td> Edit Car Type	</td>
			
				<td><input type="text" name="car_type" id="car_type" value="<?php echo $result->car_type; ?>" required></td>
