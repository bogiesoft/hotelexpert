	...
	<li><a  href="<?php echo WEB_URL ?>index/view_sub_admin_user" style="width:200px;" id="tabs_active" >View Sub Admin List</a></li>
     <?php } ?>
      ...
      <div class="rightpartbox">
        ...
        <div class="tablebox">
        <form method="post" name="admin_register" action="<?php echo WEB_URL; ?>index/sub_admin_registration_page" enctype="multipart/form-data">
          ...
          <table width="900px" align="left" border="0" cellspacing="1" cellpadding="5" style="margin-left:10px;">
            ...
            <tr>
              ...
              <select name="sub_admin_type_id"  style="width:210px; line-height:30px; padding:3px; border-radius:5px; height:30px; border:1px solid #ccc" required>
                ...
                if(isset($admin[0]->sub_admin_type_id))
                    ...
                    ?>
                      <option value="<?php echo $admin[$i]->sub_admin_type_id; ?>" <?php if(set_value('sub_admin_type_id')==$admin[$i]->sub_admin_type_id) echo "selected='selected'" ?>><?php echo $admin[$i]->sub_admin_type; ?></option>
                    <?php	
                    }
                    }
                    ?>       
            ...
            <tr>
              <td class="colo-td" align="center" colspan="2"><input type="submit"value="Create Sub Admin User"  
