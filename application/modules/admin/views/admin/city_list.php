...
<table width="986" align="center" border="0" cellpadding="0" cellspacing="0" style="border:1px #aaaaaa solid; margin-top:30px; border-top:none; border-radius:10px; ">
 ...
 <div  class="right_header"><strong><a href="<?php echo WEB_URL;?>index/dashboard">Go back</a></strong></div>
        ...
        <div class="tablebox" style="width:910px; margin:0px">
         ...
         <form name="f2" action="<?php echo WEB_URL;?>home/add_cities" method="post">
		<table width="250">
			<tr>
				...
				<td>
					...
					<select name="reg_id" id="reg_id" required>
						<option value="">Select a Region</option>
							...
							?>
								<option value="<?php echo $reg_details[$i]->id; ?>"><?php echo $reg_details[$i]->region_name; ?></option>
							<?php	
									}
								}
							?>      
        ...
        <div class="wi680_search_branc" style="width:800px; margin-top:30px">
		
		<div class="tb" style="width:740px">
            <div class="tb_sample_cover" style="width:800px">
             <div class="tb_col_01" style="background-color:#ccc; font-weight:bold; color:#000;width:140px;">Sl no</div>
            <div class="tb_col_01" style="background-color:#ccc; font-weight:bold; color:#000;width:140px;">City Name</div>
			<div class="tb_col_01" style="background-color:#ccc; font-weight:bold; color:#000;width:140px;">Region</div>
        ...
        <div class="tb_sample_cover211" style="width:740px">
        	 <div class="tr_col_01  bl_2" style="width:140px;"><?php echo $i+1; ?></div>
            <div class="tr_col_01  bl_2" style="width:140px;"><?php echo $result[$i]->city_name; ?></div>
			<div class="tr_col_01  bl_2" style="width:140px;"><?php echo $this->common_model->get_region($result[$i]->reg_id); ?></div>
            ...
            <a href="<?php echo WEB_URL;?>home/edit_city_list/<?php echo $result[$i]->id; ?>">Edit</a> /
             <a href="<?php echo WEB_URL;?>home/update_city_list/<?php echo $result[$i]->id; ?>/1">Active</a> /
              <a href="<?php echo WEB_URL;?>home/update_city_list/<?php echo $result[$i]->id; ?>/0">InActive</a>/
                <span style="font-size:12px;"><?php echo anchor(WEB_URL.'home/update_city_list/'.$result[$i]->id.'/2', '<span style="color:#2485BE;">Delete</span>', array('onClick' => "return confirm('Are you sure you want to delete?')")); ?> </span>
