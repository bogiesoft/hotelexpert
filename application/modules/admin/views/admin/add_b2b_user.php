	...
	<div class="tabs_width">
     ...
     <?php if($this->session->userdata('view_admin_users')==1) { ?>  
      ...
      <div class="rightpartbox">
        ...
        <div class="tablebox">
        <form method="post" name="admin_register" action="<?php echo WEB_URL; ?>home/b2b_registration_page" enctype="multipart/form-data">
          ...
          <table width="900px" align="left" border="0" cellspacing="1" cellpadding="5" style="margin-left:10px;">
            ...
            <tr>
              ...
              <td class="colo-td"><input type="text" name="contact_person_name" size="30" value="<?php echo set_value('office_phone_no'); ?>" />
            ...
            <tr>
              ...
              <td class="colo-td"><input type="text" name="desig_of_contact" size="30" value="<?php echo set_value('office_phone_no'); ?>" />
            ...
            <tr>
              ...
              <td class="colo-td"><textarea name="notes" cols="23" rows="5" style="width:210px; border-radius:5px; height:125px; border:1px solid #ccc"><?php echo set_value('notes'); ?></textarea>
               ...
               <tr>
              <td class="colo-td" align="left">B2B User Logo:</td>
            ...
            <tr>
              <td class="colo-td" align="center" colspan="2"><input type="submit"value="Create Supplier User"  
