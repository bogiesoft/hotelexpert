...
<ul class="tabs">
	...
	<li><a  href="<?php echo WEB_URL ?>index/view_admin_user" style="width:200px;" id="tabs_active"  >View Super Admin Details</a></li>
     <?php } ?>
        ...
        <div style="float:right; cursor:pointer; position:absolute; top:158px; right:209px; font-size:12px; padding:5px;color:#069;"><A HREF="<?php echo WEB_URL; ?>index/view_admin_user"> Go Back</A></div>
      ...
      <div class="rightpartbox">
        ...
        <div class="tablebox">
        <form method="post" name="admin_register" action="<?php echo WEB_URL; ?>index/update_admin_registration_page/<?php echo $this->uri->segment(3);?>" enctype="multipart/form-data">
          ...
          <table width="900px" align="left" border="0" cellspacing="1" cellpadding="5" style="margin-left:10px;">
            ...
            <?php /*?><tr>
              ...
              <td class="colo-td">
               <?php  $admin=$this->admin_model->get_details_of_admin();
					...
					//echo $admin_user->admin_type;exit;
	 			?>
              <select name="admin_type"  style="width:210px; line-height:30px; padding:3px; border-radius:5px; height:30px; border:1px solid #ccc" required>
                ...
                if(isset($admin[0]->admin_type_id))
                    ...
                    ?>
                      <option value="<?php echo $admin[$i]->admin_type_id; ?>" <?php if($admin_user->admin_type == $admin[$i]->admin_type_id) echo "selected='selected'" ?> ><?php echo $admin[$i]->admin_type; ?></option>
                    <?php	
                    }
                    }
                    ?>       
            ...
            <tr>
              ...
              <td class="colo-td"><input type="password" name="password" size="30"  value="<?php if(isset($admin_user->password))  echo $admin_user->password; ?>"/>
            ...
            <tr>
              ...
              <td class="colo-td"><input type="password" name="comform_password" size="30" value="<?php if(isset($admin_user->password))  echo $admin_user->password; ?>" />
            ...
            <tr>
              <td class="colo-td" align="center" colspan="2"><input type="submit"value="Update Admin User"  
