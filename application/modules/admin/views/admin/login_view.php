          ...
          <tr>
            <td valign="top" id="div-logcent-strip">
                 ...
                 <tr>
                    ...
                    Username : <br /><input  id="email" name="email" type="text" value="" class="login-txtbox"  required/>
                     <font size="2px"></font>
                    </td>
            	...
            	<tr>
                  ...
                  <!-- <tr>
                    <td  style="font-size:18px; text-align:left; color:#565656;padding-left:11px">
                    User Type :<select style="padding:5px;" name="admin_type" class="login-txtbox" required >
