	...
	<li><a  href="<?php echo WEB_URL ?>index/view_admin_user" style="width:200px;" id="tabs_active"  >View Super Admin Details</a></li>
     <?php } ?>
      ...
      <div class="rightpartbox">
       <div  class="right_header"><a href="<?php echo WEB_URL; ?>index/view_admin_user" style="color:#2485BE;">Go Back</a></div>    
        ...
        <div class="tablebox">
        <form method="post" name="admin_register" action="<?php echo WEB_URL; ?>index/admin_registration_page" enctype="multipart/form-data">
          ...
          <table width="900px" align="left" border="0" cellspacing="1" cellpadding="5" style="margin-left:10px;">
           ...
           <?php /*?> <tr>
            ...
            <tr>
              <td class="colo-td" align="center" colspan="2"><input type="submit"value="Create Admin User"  
