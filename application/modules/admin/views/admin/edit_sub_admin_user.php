	...
	<li><a  href="<?php echo WEB_URL ?>index/view_sub_admin_user" style="width:200px;" id="tabs_active" >View Sub Admin List</a></li>
     <?php } ?>
      ...
      <div class="rightpartbox">
        <div class="right_header"><a href="<?php echo WEB_URL;?>index/view_sub_admin_user" style="color:#2485BE;">Go Back</a></div>
        ...
        <div class="tablebox">
        <form method="post" name="admin_register" action="<?php echo WEB_URL; ?>index/update_sub_admin_registration_page/<?php echo $this->uri->segment(3);?>" enctype="multipart/form-data">
          ...
          <table width="900px" align="left" border="0" cellspacing="1" cellpadding="5" style="margin-left:10px;">
            ...
            <tr>
              <td class="colo-td" align="center" colspan="2"><input type="submit"value="Update Sub Admin User"  
