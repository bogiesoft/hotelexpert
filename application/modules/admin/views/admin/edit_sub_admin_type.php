...
<ul class="tabs">
    ...
    <div  class="right_header"><a href="<?php echo WEB_URL; ?>index/sub_admin_type" style="color:#2485BE;">Go Back</a></div>    
        
        <div class="tablebox"  >
        <form method="post" name="admin_type"  action="<?php echo WEB_URL; ?>index/update_sub_admin_type_details/<?php echo $admin_name->sub_admin_type_id; ?>" enctype="multipart/form-data">
          ...
          <table width="100%" align="left" border="0" cellspacing="1" cellpadding="5" style="margin-left:10px;">
            ...
            <tr>
              ...
              <td class="colo-td"><input type="text" name="admin_type" size="30" value="<?php echo $admin_name->sub_admin_type; ?>" required /></td>
