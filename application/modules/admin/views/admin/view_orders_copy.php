...
<ul class="tabs">
	...
	<li><a href="<?php echo WEB_URL ?>home/view_orders"  id="tabs_active" >View Orders</a></li>
	<li><a  href="<?php echo WEB_URL ?>home/add_orders" style="width:200px;">Place New Order</a></li>
      ...
      <div class="rightpartbox">
        ...
        <div class="tb_sample_cover211" style="width:900px">
            ...
            <div class="tr_col_01  bl_2" style="width:100px;"><?php echo $result[$i]->customer_b2b_id; ?></div>
			...
			<div class="tr_col_01  bl_2" style="width:100px;"><?php $supplier = $this->common_model->get_supplier_name($result[$i]->supplier_id); if($supplier){ echo $supplier[0]->firstname;}?></div>
