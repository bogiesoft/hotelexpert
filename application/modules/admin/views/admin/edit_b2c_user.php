  ...
  <table width="966"  border="0" align="center" style="border:1px #9d9d9d solid; margin-top:10px; background-color:#efefef; border-radius:8px;">
   ...
   <?php if($this->session->userdata('view_admin_users')==1) { ?>  
      ...
      <div class="rightpartbox">
        ...
        <div class="tablebox">
        <form method="post" name="admin_register" action="<?php echo WEB_URL; ?>index/update_b2c_registration_page/<?php echo $this->uri->segment(3);?>" enctype="multipart/form-data">
          ...
          <table width="900px" align="left" border="0" cellspacing="1" cellpadding="5" style="margin-left:10px;">
            ...
            <tr>
              ...
              <td class="colo-td"><input type="text" name="name" size="30" value="<?php if(isset($admin_user->name))  echo $admin_user->name; ?>"/>
            ...
            <tr>
            	<td></td>
                <td><?php if(isset($admin_user->user_logo) && $admin_user->user_logo != '') { ?>
   <div style="float:left;"> 
   <img src="<?php echo WEB_DIR_FRONT ?>b2c_user_logo/<?php echo $admin_user->user_logo; ?>" width="240" height="140" border="0" />
   </div>
   <?php } ?></td>
            </tr>
            <tr>
            ...
            <tr>
              <td class="colo-td" align="center" colspan="2"><input type="submit"value="Update B2C User"  
