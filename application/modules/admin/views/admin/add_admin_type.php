...
<table width="986" align="center" border="0" cellpadding="0" cellspacing="0" style="border:1px #aaaaaa solid; margin-top:30px; border-top:none; border-radius:10px; ">
  ...
  <table width="966"  border="0" align="center" style="border:1px #9d9d9d solid; margin-top:10px; background-color:#efefef; border-radius:8px;">
    ...
    <ul class="tabs1">
        ...
        <li><a href="<?php echo WEB_URL;?>index/view_admin_user" id="tabs_active" >Super Admin</a></li>
...
<ul class="tabs">
	...
	<li><a href="<?php echo WEB_URL ?>index/admin_type"  id="tabs_active"  >Create Admin Type </a></li>
    <?php } ?>
    <?php if($this->session->userdata('view_admin_users')==1) { ?>  
	<li><a  href="<?php echo WEB_URL ?>index/view_admin_user" style="width:200px;">View Super Admin Details</a></li>
     <?php } ?>
      ...
      <div class="rightpartbox">
        ...
        <div class="tablebox"  >
        <form method="post" name="admin_type" action="<?php echo WEB_URL; ?>index/add_admin_type" enctype="multipart/form-data">
          ...
          <table width="100%" align="left" border="0" cellspacing="1" cellpadding="5" style="margin-left:10px;">
            ...
            <tr>
              ...
              <td class="colo-td"><input type="text" name="admin_type" size="30" value="<?php echo set_value('admin_type'); ?>" required /></td>
               <td class="colo-td" align="center" colspan="2"><input type="submit"value="Add Admin User"  
...
for($i=0;$i<count($admin_details);$i++)
{
   ...
   <tr >
    ...
    <a href="<?php echo WEB_URL; ?>index/edit_admin_type/<?php echo $admin_details[$i]->admin_type_id; ?>">Edit</a> / 
     <?php } ?>
    ...
    <a href="<?php echo WEB_URL; ?>index/update_admin_type/<?php echo $admin_details[$i]->admin_type_id; ?>/0">InActive</a> /
     <span style="font-size:12px;"><?php echo anchor(WEB_URL.'index/update_admin_type/'.$admin_details[$i]->admin_type_id.'/2', '<span style="color:#2485BE;">Delete</span>', array('onClick' => "return confirm('Are you sure you want to delete?')")); ?> </span> 
