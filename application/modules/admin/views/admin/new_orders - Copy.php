        ...
        <form method="post" name="admin_register" action="<?php echo WEB_URL; ?>home/new_orders" enctype="multipart/form-data">
          ...
          <tr>
            ...
            <tr>
			  ...
			  <textarea style="height: 103px;width: 211px;" name="extra_products" id="extra_products"></textarea>
			...
			<tr>
			  ...
			  <?php  $supplier=$this->admin_model->get_details_of_supplier();
	 			...
	 			?>
				<select name="supplier_type" id="supplier_type"  style="width:210px; line-height:30px; padding:3px; border-radius:5px; height:30px; border:1px solid #ccc" required >
                  <option value="">Select</option>
                   <?php
            ...
            <tr>
              <td class="colo-td" align="left">Product ID :&nbsp;<font class="required">*</font><br/>
			  <input style="width:100px; line-height:30px;padding:3px; border-radius:5px; height:30px; border:1px solid #ccc" type="text" name="product_id" size="30"/>
			  <br/>
			  <?php echo form_error('product_id', '<div class="validation_error">', '</div>'); ?>
              </td>
			 ...
			 <tr>
              ...
              <td class="colo-td" align="left">Supplier ID :&nbsp;<font class="required">*</font><br/>
				...
				<div id ="suppliers">
                  ...
                  <?php  foreach($name as $supplier_id){?>
			   ...
			   <?php echo form_error('supplier_id', '<div class="validation_error">', '</div>'); ?>
			   
<script>
			   	$(document).ready(function(){
		$("#supplier_type").change(function() {	
			var supplier_type_Id		= $("#supplier_type").val();	
			window.location = "<?php echo WEB_URL ?>home/view_suppliers/"+supplier_type_Id;
			//alert(supplier_type_Id);
			...
			<tr>
              <td class="colo-td" align="left">Product Name :&nbsp;<font class="required">*</font><br/>
			  <input style="width:200px; line-height:30px;padding:3px; border-radius:5px; height:30px; border:1px solid #ccc" type="text" name="product_name" size="30"/>
			   <?php echo form_error('product_name', '<div class="validation_error">', '</div>'); ?>
              </br>
              </td> 
			  <td class="colo-td" align="left">
			  Payment Method : <br/>
