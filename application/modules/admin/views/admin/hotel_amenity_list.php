...
<table width="986" align="center" border="0" cellpadding="0" cellspacing="0" style="border:1px #aaaaaa solid; margin-top:30px; border-top:none; border-radius:10px; ">
  ...
  <table width="966"  border="0" align="center" style="border:1px #9d9d9d solid; margin-top:10px; background-color:#efefef; border-radius:8px;">
    ...
    <ul class="tabs1">
             ...
             <li><a href="<?php echo WEB_URL;?>index/amenity_list"  id="tabs_active">Hotel Amenities</a></li>
 ...
 <div  class="right_header"><strong><a href="<?php echo WEB_URL;?>index/dashboard">Go back</a></strong></div>
        ...
        <div class="tablebox" style="width:910px; margin:0px">
         ...
         <form name="f2" action="<?php echo WEB_URL;?>index/add_hotel_amenities" method="post">
		<table width="250">
			<tr>
				<td>Enter Hotel/Villa Amenities</td>
                <td></td>
			</tr>
			<tr>
				<td><input type="text" name="amenity_name" id="amenity_name" required></td>
		...
		<div class="tb" style="width:600px">
            ...
            <div class="tb_col_01" style="background-color:#ccc; font-weight:bold; color:#000;width:140px;">Amenity Name</div>
        ...
        <div class="tb_sample_cover211" style="width:600px">
            ...
            <div class="tr_col_01  bl_2" style="width:140px;"><?php echo $result[$i]->amenity_name; ?></div>
            ...
            <div class="tr_col_01 bl_1" style="width:175px;">  
             ...
             <a href="<?php echo WEB_URL;?>index/update_amenity_list/<?php echo $result[$i]->amenity_list_id; ?>/1">Active</a> /
              <a href="<?php echo WEB_URL;?>index/update_amenity_list/<?php echo $result[$i]->amenity_list_id; ?>/0">InActive</a>/
                <span style="font-size:12px;"><?php echo anchor(WEB_URL.'index/update_amenity_list/'.$result[$i]->amenity_list_id.'/2', '<span style="color:#2485BE;">Delete</span>', array('onClick' => "return confirm('Are you sure you want to delete?')")); ?> </span>
              <!-- <a href="<?php echo WEB_URL;?>index/update_amenity_list/<?php echo $result[$i]->amenity_list_id; ?>/2">Delete</a>-->
