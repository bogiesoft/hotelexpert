  ...
  <table width="966"  border="0" align="center" style="border:1px #9d9d9d solid; margin-top:10px; background-color:#efefef; border-radius:8px;">
    ...
    <ul class="tabs1">
      ...
      <div class="rightpartbox">
        <div class="right_header"><a href="<?php echo WEB_URL;?>home/view_b2b_user_details" style="color:#2485BE;">Go Back</a></div>
        ...
        <div class="tablebox">
        <form method="post" name="admin_register" action="<?php echo WEB_URL; ?>home/update_b2b_registration_page/<?php echo $this->uri->segment(3); ?>" enctype="multipart/form-data">
          ...
          <table width="900px" align="left" border="0" cellspacing="1" cellpadding="5" style="margin-left:10px;">
            ...
            <tr>
              ...
              <td class="colo-td"><input type="text" name="name" size="30" value="<?php if(isset($sup_user->name)) echo  $sup_user->name; else { echo set_value('name'); } ?>"/>
            ...
            <tr>
              ...
              <td class="colo-td"><input type="file" name="b2buser_logo" />
              </br><?php echo form_error('notes', '<div class="validation_error">', '</div>'); ?>
              </td>
            </tr>
            <tr>
            	<td></td>
                <td><?php if(isset($sup_user->user_logo)) { ?>
   <div style="float:left;"> 
   <img src="<?php echo WEB_DIR_FRONT ?>supplier_logos/<?php echo $sup_user->user_logo; ?>" width="240" height="140" border="0" />
   </div>
   <?php } ?></td>
            </tr>
            <input type="hidden" name="image1" value="<?php echo $sup_user->user_logo; ?>" />
            <tr>
