...
<table width="986" align="center" border="0" cellpadding="0" cellspacing="0" style="border:1px #aaaaaa solid; margin-top:30px; border-top:none; border-radius:10px; ">
 ...
 <div  class="right_header"><strong><a href="<?php echo WEB_URL;?>index/dashboard">Go back</a></strong></div>
        ...
        <div class="tablebox" style="width:910px; margin:0px">
         ...
         <form name="f2" action="<?php echo WEB_URL;?>index/add_hotel_room_categoty_type" method="post">
		<table width="400">
			<tr>
		...
		$room_type= $this->admin_model->get_global_room_cate_type();
        if (!empty($room_type)) {
        ...
        <div class="tb_sample_cover211" style="width:600px">
            ...
            <div class="tr_col_01  bl_2" style="width:140px;"><?php echo $room_type[$i]->category_type; ?></div>
            ...
            <div class="tr_col_01 bl_1" style="width:175px;">  
          	 <a href="<?php echo WEB_URL;?>index/edit_hotel_room_categoty_type/<?php echo $room_type[$i]->global_room_category_type_id; ?>">Edit</a> /
             <a href="<?php echo WEB_URL;?>index/update_room_hotel_facility/<?php echo $room_type[$i]->global_room_category_type_id; ?>/1">Active</a> /
             <a href="<?php echo WEB_URL;?>index/update_room_hotel_facility/<?php echo $room_type[$i]->global_room_category_type_id; ?>/0">InActive</a>/
              <span style="font-size:11px;"><?php echo anchor(WEB_URL.'index/update_room_hotel_facility/'.$room_type[$i]->global_room_category_type_id.'/2', '<span style="color:#2485BE;">Delete</span>', array('onClick' => "return confirm('Are you sure you want to delete?')")); ?> </span>
            <!-- <a href="<?php echo WEB_URL;?>index/update_room_hotel_facility/<?php echo $room_type[$i]->global_room_category_type_id; ?>/2">Delete</a>-->
