  ...
  <table width="966"  border="0" align="center" style="border:1px #9d9d9d solid; margin-top:10px; background-color:#efefef; border-radius:8px;">
    ...
    <ul class="tabs1">
        ...
        <?php if($this->session->userdata('hotel_room_inventory')== 1) { ?>
         <li><a href="<?php echo WEB_URL;?>index/hotel_room_inventory/<?php echo $this->uri->segment(3); ?>/<?php echo $this->uri->segment(4); ?>" id="tabs_active" style="width:200px;">Inventory & Pricing</a></li>
         <?php } ?>
          ...
          <div id="navjam" style="margin-top:5px;">
            <ul class="tabs">
                <?php 	if($this->session->userdata('hotel_room_inventory')==1) { ?>
                    <li><a href="<?php echo WEB_URL;?>index/hotel_room_inventory/<?php echo $this->uri->segment(3); ?>/<?php echo $this->uri->segment(4); ?>" id="tabs_active" >Manage Inventory</a></li>
                     <?php } ?>
                      <?php if($this->session->userdata('hotel_pricing')==1) { ?>
                    <li><a href="<?php echo WEB_URL;?>index/hotel_room_pricing/<?php echo $this->uri->segment(3); ?>/<?php echo $this->uri->segment(4); ?>"  style="width:200px;">Manage Pricing</a></li>
                     <?php } ?>
      ...
      <div class="rightpartbox" style="margin:0px;">
        ...
        <div style="float:right; color:#517BA5;"><a href="<?php echo WEB_URL; ?>index/hotel_room_inventory/<?php echo $this->uri->segment(3);  ?>/<?php echo $this->uri->segment(4);  ?>">Go Back</a></div>
        <div style="float:left; margin-left:20px;">
      
    
     <form name="form1" action="<?php echo WEB_URL; ?>index/update_room_inventory/<?php echo $this->uri->segment(3); ?>/<?php echo $this->uri->segment(4); ?>/<?php echo $this->uri->segment(5); ?>" method="post">
