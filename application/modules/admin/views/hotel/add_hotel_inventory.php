...
<ul class="tabs">
   ...
   <div style="float:right; color:#517BA5;"><a href="<?php echo WEB_URL; ?>index/hotel_room_inventory/<?php echo $this->uri->segment(3);  ?>/<?php echo $this->uri->segment(4);  ?>">Go Back</a></div>      
     ...
     <form name="form1" action="<?php echo WEB_URL; ?>index/add_room_inventory/<?php echo $this->uri->segment(3); ?>/<?php echo $this->uri->segment(4); ?>" method="post">
        <table width="100%" border="0" cellspacing="1" cellpadding="0">
            ...
            <tr height="35">
                <td colspan="2" style="padding-top:20px;"><b>Manage Inventory</b></td>
            </tr>
        </table>
    <!--</form>   
