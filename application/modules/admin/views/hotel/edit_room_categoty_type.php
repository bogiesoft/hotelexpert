...
<ul class="tabs">
 ...
 <div  class="right_header"><strong><a href="<?php echo WEB_URL;?>index/manage_hotels">Go back</a></strong></div>
        ...
        <div class="tablebox" style="width:910px; margin:0px">
         ...
         <form name="f2" action="<?php echo WEB_URL;?>index/update_room_categoty_type/<?php echo $this->uri->segment(3)?>/<?php echo $this->uri->segment(4)?>" method="post">
		<table width="400">
			<tr>
				<td> Edit Room Category Type	</td>
			
				<td><input type="text" name="categoty_type" id="categoty_type" value="<?php echo $result->categoty_type; ?>" required></td>
