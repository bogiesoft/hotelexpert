...
<ul class="tabs">
    ...
    <li><a href="<?php echo WEB_URL ?>index/approve_hotel_reviews/<?php echo $this->uri->segment(3); ?>">Hotel Reviews</a></li>
     <li><a href="<?php echo WEB_URL ?>index/extra_products/<?php echo $this->uri->segment(3); ?>">Extra Products</a></li>
      <li><a href="<?php echo WEB_URL ?>index/hotel_near_by_location/<?php echo $this->uri->segment(3); ?>" id="tabs_active">Near By Location</a></li>
     <?php } ?>
 ...
 <div  class="right_header"><strong><a href="<?php echo WEB_URL;?>index/manage_hotels">Go back</a></strong></div>
        ...
        <h4>Near By Location</h4>
    <form action="<?php echo WEB_URL;?>index/add_hotel_near_by_location/<?php echo $this->uri->segment(3); ?>" method="post">
    <table width="300" >
       ...
       <?php //print '<pre />';print_r($result);exit;
            ...
            if(isset($result))
            {
                ...
                <tr>
                <td>
                    <input type="checkbox" name="global_near_by_location_id[]" id="<?php echo $result[$i]->global_near_by_location_id ?>" value="<?php echo $result[$i]->global_near_by_location_id ?>" 
                     <?php if($sup_room_faci = $this->admin_model->get_hotel_near_by_location($this->uri->segment(3), $result[$i]->global_near_by_location_id)) { echo "checked='checked'" ; } ?>
                     />
                   <?php echo $result[$i]->location_name; ?>
                </td>
                </tr>	
                <?php
                }
