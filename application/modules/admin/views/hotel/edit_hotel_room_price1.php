...
<ul class="tabs">
	<li><a href="<?php echo WEB_URL ?>index/hotel_inventory_pricing/<?php echo $this->uri->segment(3); ?>"  >Room Inventory</a></li>
    <li><a href="<?php echo WEB_URL ?>index/hotel_room_pricing/<?php echo $this->uri->segment(3); ?>/<?php echo $this->uri->segment(4); ?>" id="tabs_active"  >Room Pricing</a></li>
   ...
   <tr>
    ...
    <td style="width:250px;"> Room Available Dates:<font style="margin-left: 3px;" color="red">*</font>
        ...
        ?>
    <td style="width:120px;"><input name="sd" id="datepicker2" value="<?php echo $fdate; ?>"  onchange="javascript:return check_night_valued(this.value)" type="text" class="b2b-txtbox"  style=" background-image: url('<?php echo WEB_DIR_FRONT; ?>images/b2b-calicon.png');background-repeat:no-repeat;background-position:right center;width:100px; height:18px;"/></td>
    <td >&nbsp;</td>
    <td  style="width:120px;"><span id="out"><input name="ed" value="<?php echo $tdate; ?>"  id="datepicker3" onchange="javascript:return check_night_valued(this.value)" type="text" class="b2b-txtbox" style=" background-image: url('<?php echo WEB_DIR_FRONT; ?>images/b2b-calicon.png'); background-repeat:no-repeat;background-position:right center;width:100px; height:18px;"/></span></td>
     <td style="width:20px;">
